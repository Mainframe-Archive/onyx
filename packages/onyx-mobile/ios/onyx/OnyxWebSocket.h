...
@protocol OnyxWebSocketDelegate;

#pragma mark - RCTSRWebSocket

@interface OnyxWebSocket : NSObject <NSStreamDelegate>

@property (nonatomic, weak) id<OnyxWebSocketDelegate> delegate;
...
@protocol OnyxWebSocketDelegate <NSObject>
...
- (void)webSocket:(OnyxWebSocket *)webSocket didCloseWithCode:(NSInteger)code reason:(NSString *)reason wasClean:(BOOL)wasClean;
- (void)webSocket:(OnyxWebSocket *)webSocket didReceivePong:(NSData *)pongPayload;
...
@interface NSRunLoop (OnyxWebSocket)
